...
public class FrameTests {
    ...
    public void testFrame() {
        ...
        Assertions.assertArrayEquals(new String[]{"", "A", "B", "C", "D", "E"}, frame.getColumnLabels());
        Assertions.assertArrayEquals(new String[]{"1", "2", "3"}, frame.getRowLabels());
    }
    ...
    public void testBigFrame() {
        ...
        Assertions.assertArrayEquals(expectedXAxisLabels, frame.getColumnLabels());

        // Validate y-axis labels are correct for 100 rows
        String[] expectedYAxisLabels = IntStream.rangeClosed(1, 100)
                .mapToObj(Integer::toString)
                .toArray(String[]::new);
        Assertions.assertArrayEquals(expectedYAxisLabels, frame.getRowLabels());
    }
}